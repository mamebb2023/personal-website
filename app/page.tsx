...
import NatureBreak from "@/components/home/NatureBreak";
            ...
            >
              ...
              <div className="absolute bottom-0 left-20 flex items-center flex-col">
                <div id="overlay-lotus">
                  <Lotus
                    size="h-[60px] w-[40px]"
                    gradient="bg-linear-to-b from-emerald-500 via-green-500/40 to-transparent"
                  />
                </div>
                <div
                  id="overlay-line"
                  className="h-40 w-px bg-linear-to-b from-transparent via-green-500/20 to-green-500"
                />
                <div
                  id="overlay-leaf"
                  className="absolute top-1/3 -left-1/2 bg-linear-to-br from-emerald-600 to-green-500 w-10 h-5 rounded-tl-full rounded-br-full"
                />
              </div>
              ...
              <div className="circle-box absolute -top-40 -left-40 size-80 flex-center">
                ...
                <div className="absolute size-[80%] bg-linear-to-tr from-green-500 to-emerald-500 rounded-full overlay-circle" />
              </div>

              <div className="absolute top-0 right-0 w-96 h-96 bg-linear-to-br from-emerald-400/20 via-green-500/10 to-transparent rounded-full blur-3xl overlay-circle" />
              <div className="absolute bottom-40 left-60 w-80 h-80 bg-linear-to-tr from-teal-400/15 via-green-400/10 to-transparent rounded-full blur-3xl overlay-circle" />
        ...
        <div className="md:hidden">
          ...
          <div id="hero" className="relative">
            ...
            >
              ...
              <motion.h1
                ...
                className="text-2xl font-bold max-w-125 uppercase tracking-wider transition-all text-green-500/70 text-center"
              >
          ...
          <div id="projects" className="relative min-h-screen">
            <div className="flex-center flex-col">
              <div className="text-[20vw] font-bold leading-none text-green-500/50 select-none pointer-events-none">
                ;
              </div>
              ...
              <h1
                id="projects-text"
                className="text-4xl uppercase tracking-[15px]"
              >
                Projects
              </h1>
            </div>
            ...
            <div className="py-5 flex-center flex-col gap-5">
              {projects.map((p, i) => (
                <div
                  key={i}
                  className="relative size-[calc(100vw-10vw)] md:size-[calc(100vw-20vw)] border border-green-500 rounded-3xl p-4"
                >
